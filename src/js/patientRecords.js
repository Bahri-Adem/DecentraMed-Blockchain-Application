    ...
    if(await App.Authcontract.methods.checkRegister(addr).call()){
        ...
        while(res.patient_addr != "0x0000000000000000000000000000000000000000"){
            ...
            if(res.document_type=="Prescription / Ordonnance médicale"){
                ...
                Link.innerHTML =  "<a id='test' class='test' href='https://ipfs.io/ipfs/QmUEzLrXBftxVACXRAERkJdftja9yKmoJZaVTLQuN24L6B'>preview</a><div id='testing' class='imgContainer hide'><img id='jojo"+i+"' src='' alt=''/></div>"
