...
contract Auth {
    ...
    function Add_document(
        ...
        string memory _uses_day,
        string memory _days_number,
        string memory _condition,
        string memory _ordo_descrition
    ) public {
        require(users[msg.sender].role == UserRole.Doctor);
        require(users[_patient_addr].role == UserRole.Patient);
        uint _doc_id = patients[_patient_addr].patient_docCount;
        patient_documents[_patient_addr][_doc_id] = Document(_patient_addr, msg.sender, _document_type, _document_description, docCount,  _document_link, _date, _drug_name, _uses_day, _days_number, _condition, _ordo_descrition);
